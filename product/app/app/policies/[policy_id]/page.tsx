  ...
  return (
    <PageContainer spacing={6}>
      <PageHeader
        ...
        back={{ href: "/app/policies", label: "← Back to Policies" }}
        action={
          <div className="flex gap-2">
            <ButtonLink href={`/app/policies/${policy_id}/eligibility`}>
              Check Eligibility
            </ButtonLink>
            <ButtonLink href={`/app/policies/${policy_id}/ask`} variant="secondary">
              Ask Policy AI
            </ButtonLink>
          </div>
        }
      ...
      <Card title="Policy Summary">
        <p className="text-sm text-gray-600">
          This policy has {rules.length} extracted rule(s). Use Ask Policy AI for questions or Check Eligibility to evaluate an applicant.
        </p>
      </Card>

      <Card title="Extracted Rules" padding={false}>
