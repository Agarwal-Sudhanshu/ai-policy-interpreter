        ...
        {policies.map((p) => (
          <TableRow key={p.id}>
            ...
            <TableCell className="text-right">
              <ButtonLink href={`/app/policies/${p.id}`} variant="secondary">
                Open
              </ButtonLink>
            </TableCell>
          </TableRow>
    ...
    <PageContainer spacing={6}>
      ...
      <Card title="Recent Policies" padding={false}>
        <PolicyList
          ...
          emptyMessage={user ? "No policies yet. Create one from Policies or upload a document." : "No demo policies available yet."}
        />
      </Card>
    </PageContainer>
  );
