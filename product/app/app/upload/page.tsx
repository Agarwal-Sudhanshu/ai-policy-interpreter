  ...
  return (
    <PageContainer spacing={6}>
      <PageHeader
        ...
        back={{ href: "/app/dashboard", label: "← Dashboard" }}
      />

      <Card title="Upload policy">
        <div className="space-y-6">
          ...
          {!selectedOrgId ? (
            ...
            <p className="text-sm text-gray-500">
              No products. <Link href="/app/products" className="underline">Add one</Link> first.
            </p>
          ) : (
            <Select
              label="Product"
          ...
          {!selectedProductId ? (
            ...
            <p className="text-sm text-gray-500">
              No policies. <Link href="/app/policies" className="underline">Add one</Link> first.
            </p>
          ) : (
            <Select
              label="Policy"
          ...
          <Section title="Policy name & PDF">
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <div>
                ...
                <input
                  ...
                  className="block w-full text-sm text-gray-600 file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-sm file:font-medium file:bg-gray-100 file:text-gray-800 hover:file:bg-gray-200"
              ...
              {uploadLoading && (
                <Alert variant="info" box>
                  Uploading… Processing policy and extracting rules.
                </Alert>
              )}
              <Button
                type="submit"
            ...
            {uploadSuccess && uploadStatusMessage && (
              <Alert variant={uploadStatusVariant} box role="status" className="mt-4">
                {uploadStatusMessage}
              </Alert>
            )}
          </Section>
